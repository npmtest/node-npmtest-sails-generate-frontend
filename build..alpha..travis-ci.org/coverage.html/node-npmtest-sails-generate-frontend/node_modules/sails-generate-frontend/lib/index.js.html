...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails-generate-frontend/node_modules/sails-generate-frontend/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-sails-generate-frontend">npmtest-sails-generate-frontend (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-sails-generate-frontend/node_modules/sails-generate-frontend/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails-generate-frontend/node_modules/sails-generate-frontend/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
		...
		'./assets/js/dependencies/angular.min.js': { exec: <span class="fstat-no" title="function not covered" >function (scope, cb) {</span>
<span class="cstat-no" title="statement not covered" >				if (scope.frontend !== 'angular') <span class="cstat-no" title="statement not covered" >return cb();</span></span>
<span class="cstat-no" title="statement not covered" >				var src = require('path').resolve(__dirname,'../templates/assets/js/dependencies/angular.min.js');</span>
<span class="cstat-no" title="statement not covered" >				require('fs-extra').copy(src, scope.rootPath, cb);</span>
		} },
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 09:27:43 GMT+0000 (UTC)</div>
</div>
</body>
</html>
